...
public class Utility {
    ...
    public static List<FollowableUser> createSampleFollowableUserList() {
        ...
        followableUsers.add(new FollowableUser("1", "Wayne", "Doe",
                true, "Mar 07, 2024, 10:54 PM"));
        followableUsers.add(new FollowableUser("2", "Alexander", "Doe",
                false, "Mar 05, 2024, 11:00 AM"));
        followableUsers.add(new FollowableUser("3", "Fira", "Smith",
                true, "Mar 06, 2024, 09:30 AM"));
        followableUsers.add(new FollowableUser("4", "Toshika", "Brown",
